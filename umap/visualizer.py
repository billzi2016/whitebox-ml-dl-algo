...
class UMAPAnimator:
    ...
    def _set_current_bounds(self, y):
        ...
        self.ax.set_xlim(x_min - x_span * 0.12, x_max + x_span * 0.12)
        self.ax.set_ylim(y_min - y_span * 0.12, y_max + y_span * 0.12)
    ...
    def draw_frame(self):
        ...
        self.ax.set_title(
            ...
            f"cross-entropy {snapshot['loss']:.4f}",
            fontsize=14,
        )
